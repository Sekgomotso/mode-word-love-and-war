...
function mostUsedWord() {
    ...
    fs.readFile(book, 'utf-8', (err, data) => {
        ...
        console.log(arrayOfWords[0].name + " is the most frequently occuring word");
        console.log(arrayOfWords[6].name + " is the 7th most frequently occuring word");
    ...
    function sortWords(wordsObject){
        ...
        arrayOfWords = Object.keys(wordsObject).map(name => {
          ...
          arrayOfWords.sort(function (firstWord, lastWord) {
